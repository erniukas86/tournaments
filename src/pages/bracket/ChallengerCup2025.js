      ...
      {tabIndex === 0 && <>
        <div className={styles.row}>
          <div className={styles.column}>
            <VersusCard numberOfGame={1} currentResult={{ homeName: 'Domante Zukauskaite (C6)', homeScore: undefined, awayName: 'B6', awayScore: undefined }}></VersusCard>
            <VersusCard numberOfGame={2} currentResult={{ homeName: 'Greta Krisciunaite (C5)', homeScore: undefined, awayName: 'B7', awayScore: undefined }}></VersusCard>
          ...
          <div className={styles.column}>
            ...
            <VersusCard numberOfGame={8} currentResult={{ homeName: 'Winner of game #4', homeScore: undefined, awayName: 'B5', awayScore: undefined }}></VersusCard>
          </div>
