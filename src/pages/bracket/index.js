  ...
  return (
    ...
    <>
      ...
      {tabIndex === 0 && <>
        <div className={styles.row}>
          ...
          <div className={styles.column} style={{ gap: '200px' }}>
            <VersusCard numberOfGame={7} currentResult={{ homeName: 'Martynas Juzaitis (A1)', homeScore: 0, awayName: 'Klaidas Pilkis (B2)', awayScore: 3 }}></VersusCard>
      ...
      {tabIndex === 1 && <div className={styles.row}>
        <div className={styles.column}>
          <VersusCard numberOfGame={10} currentResult={{ homeName: 'Martynas Juzaitis (A1)', homeScore: 2, awayName: 'Laimonas Mikelionis (B3)', awayScore: 3 }}></VersusCard>
        </div>
      </div>}
      {tabIndex === 2 && <>
        <div className={styles.row}>
          <div className={styles.column} style={{ gap: '200px' }}>
            ...
            <VersusCard numberOfGame={12} currentResult={{ homeName: 'Rokas Jankauskas (A2)', homeScore: 3, awayName: 'Paulius Vaitkevicius (B5)', awayScore: 2 }}></VersusCard>
          </div>
          <div className={styles.column}>
            <VersusCard numberOfGame={13} currentResult={{ homeName: 'Simas Bakus (A3)', homeScore: 2, awayName: 'Rokas Jankauskas (A2)', awayScore: 3 }}></VersusCard>
          </div>
        </div>
