    ...
    <>
      ...
      {tabIndex === 0 && <div className={styles.row}>
        <div className={styles.column}>
          <VersusCard currentResult={{ homeName: 'Tadas Kucinskas (A7)', awayName: 'Deividas Knoraitis (B8)' }}></VersusCard>
          <VersusCard currentResult={{ homeName: 'Henrikas Miliunas (B7)', awayName: 'Karolis Vaitele (A8)' }}></VersusCard>
        ...
        <div className={styles.column}>
          <VersusCard currentResult={{ homeName: 'Winner of #4 game', awayName: 'Winner of #5 game' }}></VersusCard>
        </div>
      </div>}
