  ...
  return (
    ...
    <>
      ...
      {tabIndex === 0 && <>
        <div className={styles.row}>
          ...
          <div className={styles.column} style={{ gap: '200px' }}>
            <VersusCard numberOfGame={9} currentResult={{ homeName: 'Ernestas Burokas (A1)', homeScore: 3, awayName: 'Klaidas Pilkis (C1)', awayScore: 1 }}></VersusCard>
            <VersusCard numberOfGame={10} currentResult={{ homeName: 'Dmytro Ivanchenko (B1)', homeScore: 3, awayName: 'Martynas Juzaitis (C2)', awayScore: 2 }}></VersusCard>
          </div>
          <div className={styles.column}>
            <VersusCard numberOfGame={11} currentResult={{ homeName: 'Ernestas Burokas (A1)', homeScore: undefined, awayName: 'Dmytro Ivanchenko (B1)', awayScore: undefined }}></VersusCard>
          </div>
        </div>
      ...
      {tabIndex === 2 && <>
        <div className={styles.row}>
          <div className={styles.column} style={{ gap: '200px' }}>
            ...
            <VersusCard numberOfGame={14} currentResult={{ homeName: 'Andrejus Ivascenko (A2)', homeScore: 0, awayName: 'Rokas Jankauskas (D1)', awayScore: 3 }}></VersusCard>
          </div>
          <div className={styles.column}>
            <VersusCard numberOfGame={15} currentResult={{ homeName: 'Karolis Vaitele (D2)', homeScore: 3, awayName: 'Rokas Jankauskas (D1)', awayScore: 2 }}></VersusCard>
          </div>
        </div>
      ...
      {tabIndex === 3 && <div className={styles.row}>
        <div className={styles.column}>
          <VersusCard numberOfGame={16} currentResult={{ homeName: 'Laimonas Mikelionis (B2)', homeScore: undefined, awayName: 'Andrejus Ivascenko (A2)', awayScore: undefined }}></VersusCard>
        </div>
      </div>}
    </>
  );
