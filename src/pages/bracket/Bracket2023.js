      ...
      {tabIndex === 0 && <>
        <div className={styles.row}>
          <div className={styles.column}>
            <VersusCard numberOfGame={1} currentResult={{ homeName: '(A5)', homeScore: '-', awayName: '(B4)', awayScore: '-' }}></VersusCard>
            <VersusCard numberOfGame={2} currentResult={{ homeName: '(A3)', homeScore: '-', awayName: '(B6)', awayScore: '-' }}></VersusCard>
            <VersusCard numberOfGame={3} currentResult={{ homeName: '(A6)', homeScore: '-', awayName: '(B3)', awayScore: '-' }}></VersusCard>
            <VersusCard numberOfGame={4} currentResult={{ homeName: '(A4)', homeScore: '-', awayName: '(B5)', awayScore: '-' }}></VersusCard>
          </div>
          <div className={styles.column}>
            <VersusCard numberOfGame={5} currentResult={{ homeName: 'Ernestas Burokas (A1)', homeScore: '-', awayName: 'Winner of #1', awayScore: '-' }}></VersusCard>
            <VersusCard numberOfGame={6} currentResult={{ homeName: '(B2)', homeScore: '-', awayName: 'Winner of #2', awayScore: '-' }}></VersusCard>
            ...
            <VersusCard numberOfGame={8} currentResult={{ homeName: 'Winner of #4', homeScore: '-', awayName: '(B1)', awayScore: '-' }}></VersusCard>
          </div>
