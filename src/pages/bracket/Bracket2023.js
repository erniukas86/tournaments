  ...
  return (
    ...
    <>
      ...
      {tabIndex === 0 && <>
        <div className={styles.row}>
          ...
          <div className={styles.column}>
            ...
            <VersusCard numberOfGame={6} currentResult={{ homeName: 'Klaidas Pilkis (B2)', homeScore: '-', awayName: 'Martynas Juzaitis (A3)', awayScore: '-' }}></VersusCard>
            ...
            <VersusCard numberOfGame={8} currentResult={{ homeName: 'Andrejus Ivascenko (A4)', homeScore: '-', awayName: 'Laimonas Mikelionis (B1)', awayScore: '-' }}></VersusCard>
          </div>
          <div className={styles.column} style={{ gap: '200px' }}>
            ...
            <VersusCard numberOfGame={10} currentResult={{ homeName: 'Rokas Jankauskas (B3)', homeScore: '-', awayName: 'Winner of #8', awayScore: '-' }}></VersusCard>
          </div>
          <div className={styles.column}>
      ...
      {tabIndex === 2 && <>
        <div className={styles.row}>
          <div className={styles.column} style={{ gap: '200px' }}>
            ...
            <VersusCard numberOfGame={14} currentResult={{ homeName: 'Dmytro Ivanchenko (A2)', homeScore: '-', awayName: 'Looser of #8', awayScore: '-' }}></VersusCard>
          </div>
          <div className={styles.column}>
        ...
        <>
          <div className={styles.row}>
            <div className={styles.column} style={{ gap: '200px' }}>
              ...
              <VersusCard numberOfGame={18} currentResult={{ homeName: 'Karolis Vaitele (A6)', homeScore: '-', awayName: 'Robertas Kalninis (B5)', awayScore: '-' }}></VersusCard>
            </div>
            <div className={styles.column}>
      ...
      {tabIndex === 5 && <div className={styles.row}>
        <div className={styles.column}>
          <VersusCard numberOfGame={20} currentResult={{ homeName: 'Looser of #17', homeScore: '-', awayName: 'Looser of #18', awayScore: '-' }}></VersusCard>
        </div>
      </div>}
    </>
  );
