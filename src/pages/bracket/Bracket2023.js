    ...
    <>
      ...
      {tabIndex === 0 && <>
        <div className={styles.row}>
          ...
          <div className={styles.column}>
            <VersusCard numberOfGame={11} currentResult={{ homeName: 'Ernestas Burokas (A1)', homeScore: 3, awayName: 'Laimonas Mikelionis (B1)', awayScore: 0 }}></VersusCard>
          </div>
        </div>
      ...
      {tabIndex === 1 && <div className={styles.row}>
        <div className={styles.column}>
          <VersusCard numberOfGame={12} currentResult={{ homeName: 'Klaidas Pilkis (B2)', homeScore: 3, awayName: 'Rokas Jankauskas (B3)', awayScore: 2 }}></VersusCard>
        </div>
      </div>}
      {tabIndex === 2 && <>
        <div className={styles.row}>
          <div className={styles.column} style={{ gap: '200px' }}>
            <VersusCard numberOfGame={13} currentResult={{ homeName: 'Rokas Sidaravicius (A5)', homeScore: 1, awayName: 'Martynas Juzaitis (A3)', awayScore: 3 }}></VersusCard>
      ...
      {tabIndex === 3 && <div className={styles.row}>
        <div className={styles.column}>
          <VersusCard numberOfGame={16} currentResult={{ homeName: 'Rokas Sidaravicius (A5)', homeScore: 0, awayName: 'Andrejus Ivascenko (A4)', awayScore: 3 }}></VersusCard>
        </div>
      </div>}
